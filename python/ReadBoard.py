...
def ReadURL(url):
    ...
    imagesb = soup.findAll("div", {"class": "GrowthUnauthPinImage"})  
    imagess = []
    for image in imagesb:
        newimagee = []
        imagesc = image.findAll("a")
        imagesource = image.findAll("img" , {"class": "GrowthUnauthPinImage__Image"})
...
if __name__ == '__main__':
    ...
    # ReadURL('https://www.pinterest.com/justin_jaro/character-design/')
